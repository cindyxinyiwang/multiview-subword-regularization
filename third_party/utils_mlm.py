...
class InputExample(object):
  """A single training/test example for MLM."""

  def __init__(self, guid, words, langs=None):
...
class InputFeatures(object):
  ...
  def __init__(self, input_ids, input_mask, segment_ids, langs=None, subword_ids=None):
...
def read_examples_from_file(data_dir, mode, lang, lang2id=None):
  #file_path = os.path.join(data_dir, lang, "{}wiki-latest-pages-articles_preprocessed.txt".format(lang))
  file_path = os.path.join(data_dir, "{}-{}.tsv".format(mode, lang))
